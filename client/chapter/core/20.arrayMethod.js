...
//     imageSrc: "Gakz32",
//   },
//   { id: 2, name: "한태희", age: 13, job: "삐돌이", imageSrc: "Fkzoq81" },
//   { id: 3, name: "이원명", age: 81, job: "이도령", imageSrc: "Tq9z1i" },
// ];

// /* 요소 순환 ---------------------------- */

// // forEach 값을 반환하지 X
// // people.forEach((item, index, array) 파라미터의 array는 자신을 가리킴
// let nameArray = [];
...
// // 이벤트가 많을 때 이런 방식을 쓰면 되나요? X 이벤트 위임(event delegation)
...
// // splice
// // const splice = arr.splice(1, 2, "javascript", "css"); // slice는 칼로 도려내는 거고, splice는 slice의 상위 버전
...
// // 해당되는 대상 여러 개를 배열로 반환
// const 젊은이들 = people.filter((item) => {
//   return item.name === "박가희";
// });

// // 제일 처음 찾은 대상 반환
// // find는 객체 자체 반환, findIndex는 인덱스 반환
